...
contains
  ...
  !   do i = 1, size(x)
  !   end do
  !   call gridIdx_loc(xtab, x, iix, ax, mext)
  !   call intpTab_Akima_oR(xtab, ytab1, ax, y1, mext, iix, dydx1)
  !   call intpTab_Akima_oR(xtab, ytab2, ax, y2, mext, iix, dydx2)
  !   call intpTab_Akima_oR(xtab, ytab3, ax, y3, mext, iix, dydx3)
  !   ...
  !-
  ...
  !   end do
  !   call intpTab_Akima_o1R(xtab, ytab1, ax, y1, mext, iix, dydx1)
  !   call intpTab_Akima_o1R(xtab, ytab2, ax, y2, mext, iix, dydx2)
  !   call intpTab_Akima_o1R(xtab, ytab3, ax, y3, mext, iix, dydx3)
  !   ...
  !-
